    ...
    <form method="post" action="{{route ('update', ['question'=>$question->id]) }}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div>
                ...
                <input type="text" name="indication" value="{{$question->indication}}">
                <!--textarea cols="17" rows="5" name="indication"></textarea-->
                <hr>
                <label>Type</label>
                <input type="text" name="type" value="{{$question->type}}">
                <hr>
                <label>reponses</label>
                <input type="text" name="reponse" value="{{$question->reponse}}">
                <br></br>
                <!--select  name="answer">
